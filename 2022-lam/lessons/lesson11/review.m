%% Lesson 11: MATLAB review
% This will be a birds-eye view or cheat sheat of everything we've learned
% this semester!
clc; clear; close all;

%% Style Recommendations
% * Header comment at the top of each file, describing the file.
% * Avoid long lines.
% * For maintainability, use variables to store constants/parameters
%   and functions to factor repeated code.
% * Use sections to separate execution.
% * Comments! As necessary, or maybe a little more than necessary.
% * Sensible variables names. These should implicitly document your code.
% * Suppress long outputs.
...
% * alternative syntax: function syntax (hold('on')) or command syntax
%   (hold on)

%% Vectorization and For Loops
...
% * Preallocate to avoid extra slow memory operations
...
%% Object-Oriented MATLAB (Classes, Objects and Structs)
...
%% Filters and the Filter Designer
% filterdesigner
...
%% App Designer
% Design graphical interfaces to run MATLAB code interactively!
appdesigner;
