%% Lesson 10c. SVM Demo
% The following was an example script used to learn
% about how SVM's work. This is much easier with
% MATLAB's builting tools for quadratic programming
% (convex optimization).
%
% This requires the MATLAB Optimization Toolbox.
clc; clear; close all;
...
% The SVM minimizes a quadratic matrix equation.
% This operation is convex and simple enough to have a
% closed form solution, which is the SVM. It attempts
% to find a (linear) hyperplane dividing the set of
% positive and negative examples such that the "gutter"
% between the hyperplane and the points is maximized.
n = size(xys, 1);
