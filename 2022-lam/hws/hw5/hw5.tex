...
\item Take a minute to research the \href{https://en.wikipedia.org/wiki/Iris_flower_data_set}{fisheriris dataset} (it's a popular dataset, you might see it again in an ML class).
  ...
  \item Create a constructor for \mintinline{matlab}|Flower|. It should take in four doubles and a character array corresponding, in order, to the five properties of your class.
    ...
    \clearpage
  \item Now, import the entries from from \mintinline{matlab}|meas| and \mintinline{matlab}|species| into a $150\times 1$ cell array of \mintinline{matlab}|Flower| instances. You can use a \mintinline{matlab}|for| loop to import the entries, or look up a way to vectorize the initialization (although the vectorization may take a few extra lines in this case).
