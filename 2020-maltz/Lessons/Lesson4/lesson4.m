...
%% Control Sequences
%
% Similar to C, MATALB has control sequence commands. Last class we explored
% for loops and the difference between for loops and vectorization. Even
% though vectorization is more computationally efficient than loops,
% sometimes for loops, and other control sequences, are necessary, such as
% to perform simulations. However, assuming that everyone has an
% understanding of control sequences, I would not delve too deep into the
% discussion of the mechanics of if and while statements, but rather, I
% would show you the semantics of the statmeents. 
